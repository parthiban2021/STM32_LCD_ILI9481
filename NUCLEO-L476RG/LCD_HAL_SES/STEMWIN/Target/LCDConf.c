...
{
    LCD_WR_MULTIBYTE_DATA(pData, NumItems);
}
...
*
* Function description:
*   Reads a value from a display register
*/
...
{
    LCD_RD_MULTIBYTE_DATA(pData, NumItems);
}
...
void LCD_X_Config(void) 
{
    ...
    //reference: https://forum.segger.com/index.php/Thread/5986-I-am-trying-to-interface-a-STM32F103C8-to-a-ili9341-display-in-spi-only-mode-for/
    ...
    GUIDRV_FlexColor_SetFunc(pDevice, &PortAPI, GUIDRV_FLEXCOLOR_F66709, GUIDRV_FLEXCOLOR_M24C0B8);      //ILI9481 - 24bpp (16bpp padded), 8bit bus 
}
